...
var cnItems = {
    ...
    "\"Rusty Dagger\"": "“生锈的匕首”",
    "[Winter]": "[冬季]",
    "\"Deck 10: Science Labs - Moderate Resistance\"": "甲板 10：科学实验室 - 中等阻力”",
    "\"Deck 11: Cargo Bay - Tough Resistance\"": "甲板 11: 货舱 - 坚韧的抵抗”",
    "\"Deck 9: Crew Quarters - Light Resistance\"": "\"甲板 9: 船员宿舍 - 耐光性\"",
    "\"hmm I like Deck 9...zzz\"": "\"嗯，我喜欢甲板 9...zzz\"",
    "\"Redshirt\"": "“红衫军”",
    "\"Select the deck\"": "\"选择牌组\"",
    "\"Wha...zzz\"": "“什么……嘶嘶”",
    "\"Yes Sir!\"": "\“是的先生！\”",
    "|Deck 9, Crew Quarters|": "|9 号甲板，船员宿舍|",
    "🔴ALL HANDS TO BATTLESTATIONS🔴": "🔴全力以赴的战斗🔴",
    "🔴INTRUDER ALERT ON DECKS 9, 10 and 11🔴": "🔴甲板 9、10 和 11 上的入侵者警报🔴",
    "🔴RED ALERT🔴": "🔴红色警报🔴",
    "A broken rifle": "一把破损的步枪",
    "An informal ranking system between Starfleet Security personnel. The lower the number the stronger you are": "星际舰队安保人员之间的非正式排名系统。 数字越小你越强",
    "Damaged in an attack, this rifle can be used as a makeshift club as a last resort": "在一次攻击中受损，这支步枪可以作为临时俱乐部作为最后的手段",
    "Determines gadget damage dealt and received": "确定小工具造成和受到的伤害",
    "Hypospray": "低密度射线",
    "lvl:1 'Klingon'": "lvl:1 '克林贡'",
    "lvl:1 'Redshirt'": "lvl:1 '红衫军'",
    "Melee": "近战",
    "Melee, Blunt": "近战，钝器",
    "Neck": "脖子",
    "New arrival to the ship. The average lifespan of a new Redshirt is measured in hours": "新来的船。 新红衫军的平均寿命以小时为单位",
    "QQ群号": "QQ群号",
    "Redshirt": "红衫军",
    "Redshirt rank": "红衫军等级",
    "Surface Scan: [🍂]": "表面扫描：[🍂]",
    "v102": "v102",
    "Voice from Doorway: Get out of your bunk crewman, the Klingons are attacking!": "门口的声音：离开你的铺位船员，克林贡人正在进攻！",
    "Hypospray with minor analgesic properties. Can somewhat speed up recovery of wounds and breakages.": "具有轻微镇痛特性的 低密度射线。 可以在一定程度上加快伤口和破损的恢复。",
    "\"You are fighting Klingon boarders\"": "“你在和克林贡寄宿生战斗”",
    "|Your Quarters, Bed|": "|你的宿舍，床|",
    "\"Examine Access Panel\"": "\"检查访问面板\"",
    "\"Examine Replicator\"": "\"检查复制器\"",
    "\"Examine your footlocker\"": "“检查你的储物柜”",
    "|Your Quarters|": "|你的宿舍|",
    "Angry Klingon": "愤怒的克林贡语",
    "Angry Klingon ->": "愤怒的克林贡语 ->",
    "Angry Klingon missed": "愤怒的克林贡人错过了",
    "Angry Klingon was defeated": "愤怒的克林贡人被击败",
    "Hypospray with minor analgesic properties. Can somewhat speed up recovery of wounds and breakages.": "具有轻微镇痛特性的 Hypospray。 可以在一定程度上加快伤口和破损的恢复。",
    "Removed from your wounded body before you were revived by the ship's doctor. Luckier than most redshirts": "在你被船上的医生救活之前从你受伤的身体中取出。 比大多数红衫军幸运",
    "Torn Redshirt": "撕裂的红衫",
    "Your crew quarters. You can rest here.": "你的船员宿舍。 你可以在这里休息。",
    "\"Install a small power cell\"": "\"安装一个小型电池\"",
    "\"Jury-rig power from a broken weapon\"": "\"来自破损武器的陪审团权力\"",
    "\"Quarters Assignment\"": "\"宿舍作业\"",
    "\"Retrieve spare power cells.\"": "\"取回备用电池。\"",
    "|Your Quarters, Replicator|": "|你的宿舍，复制器|",
    "A small power cell, useful for powering devices": "一种小型电池，可用于为设备供电",
    "It stores your requisition chit balance": "它存储您的申请筹码余额",
    "Personal Replicator. You can modify recipes here if you power it up": "个人复制器。 如果你打开它，你可以在这里修改食谱",
    "Personal Replicator. You'll need power if you want to modify the replicator": "个人复制器。 如果要修改复制器，则需要电源",
    "Personal Requisition Chit": "个人申请表",
    "Small power cell": "小功率电池",
    "This is your personal wallet, you received it as part of your standard kit": "这是您的个人钱包，您已将其作为标准套件的一部分收到",
    "This PADD lists your crew quarters assignment, as well as the ship's rules. Due to casualties from the war, you are the sole occupant.": "该 PADD 列出了您的船员宿舍分配以及船舶规则。 由于战争造成的伤亡，您是唯一的居住者。",
    "You have some power cells lying around nearby": "你附近有一些电池",
    "You reach for a small red security locker which you keep your valuables in, it is time to take it out": "你伸手去拿一个小的红色安全储物柜，把贵重物品放在里面，是时候把它拿出来了",
    "\"Cobble power from a broken weapon\"": "\“从破碎的武器中获得能量”",
    "\"Devise a small power cell\"": "\“设计一个小型电池\”",
    "\"Idea PADD\"": "\"想法垫\"",
    "\"Plasma Rifle\"": "“等离子步枪”",
    "A medium requisition chit. Activate it to add the chits to your file": "一个中等的申请单。 激活它以将筹码添加到您的文件中",
    "A single requisition chit, a form of currency onboard Starfleet vessels that are heavily undersupplied during the war.": "一个单一的申请单，一种在战争期间供应严重不足的星际舰队船只上的货币形式。",
    "A small requisition chit. Activate it to add the chits to your file": "一个小小的申请单。 激活它以将筹码添加到您的文件中",
    "An old plasma rifle that fires superheated plasma against enemy targets. Powered by sarium power cells": "一种老式等离子步枪，可向敌方目标发射过热等离子。 由 sarium 电池供电",
    "Personal PADD with information that you wrote yourself to remember things.": "个人 PADD，包含您自己编写的信息以记住事情。",
    "Plasma Rifle": "等离子步枪",
    "Regular drinkable water ration": "定期饮用水配给",
    "Rifle": "步枪",
    "Rifle, Blunt": "步枪，钝器",
    "Something you forgot to grab before. There's a pack of food and a PADD with some personal information.": "之前忘记拿的东西。 有一包食物和一个带有一些个人信息的 PADD。",
    "The replicator is glowing warmly": "复制器发出温暖的光芒",
    "You notice the replicator flickering slightly": "你注意到复制器轻微闪烁",
    "": "",
    "": "",
    "": "",
    "": "",
...
var cnRegReplace = new Map([
    ...
    [/^Area: Deck (.+): Science Labs \/ (.+)$/, '区域：甲板 $1：科学实验室 \/ $2'],
